...
#do
#
#    python ./src/main.py --config ./configs/waterbirds_cc.yml --epochs $epochs --model resnet50_np resnet50  --seed $seed --alpha $alpha --perturb_type ood_is_test  --results_base_folder two_models --group two_models_dbat_tuning
#
#done
#done
#done

#for first_epoch in 25 100
#do
...
#do
#
#    python ./src/main.py --config ./configs/waterbirds_cc.yml --epochs $epoch --ensemble_size 3 --model resnet50_np resnet50_np resnet50   --seed $seed --alpha $alpha --perturb_type ood_is_test  --results_base_folder three_models --group two_models_dbat_epoch
#
#done
#done
#done
...
do
    ...
    python ./src/main.py --config ./configs/waterbirds_cc.yml  --inverse_correlation  --epochs $epochs --model resnet50_np resnet50  --seed $seed --alpha $alpha --perturb_type ood_is_test  --results_base_folder two_models_IC --group two_models_dbat_IC
